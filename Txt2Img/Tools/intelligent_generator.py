...
# -*- coding: utf-8 -*-
"""
Intelligent Prompt Generator - Used with Claude Skill
Semantic understanding, commonsense reasoning, consistency checking
"""
...
def get_default_db_path() -> str:
    """Get default database path relative to PAI_DIR"""
    pai_dir = os.getenv('PAI_DIR', os.path.expanduser('~/.claude'))
    return os.path.join(pai_dir, 'skills/Txt2Img/Data/elements.db')


class IntelligentGenerator:
    """Intelligent Prompt Generator - understands intent, checks consistency"""
