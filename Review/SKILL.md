...
|----------|---------|------|
| **CodeReview** | "review", "check changes", PR URL | `Workflows/CodeReview.md` |
...
**Composes with:**
- **RequestingCodeReview** - Formal review request workflow
- **ReceivingCodeReview** - Handling feedback from reviews

**Invokes:**
- **DispatchingParallelAgents** - Spawns parallel review agents
