...
- **MUST end response with:** `🗣️ [AgentType]: [Brief summary of findings]`

**Example prompt structure:**
```
Search for: [angle]. Return findings.

End your response with:
🗣️ ClaudeResearcher: [Brief summary of what you found - max 16 words]
```
