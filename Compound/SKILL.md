...
|----------|---------|------|
| **Capture** | "document fix", "compound", "that worked" | `Workflows/Capture.md` |
...
**Called by:**
- **SystematicDebugging** - After fixing bugs, documents the solution
- **ExecutingPlans** - Can capture learnings after completing tasks

**Outputs to:**
- `plans/solutions/` directory for searchable institutional knowledge
