...
> **Trigger:** "setup notebooklm" OR "authenticate notebooklm" OR first-time setup
> **Input:** None (user completes login in browser)
> **Output:** Authentication status confirmed
...
| Step | Resource/Skill |
|------|----------------|
| Status check | Authenticate.ts status |
| Setup | Authenticate.ts setup |
| Verify | ManageNotebook.ts list |
