...
> **Trigger:** "query notebook" OR "ask my docs" OR question about notebooks
> **Input:** Question to answer using notebook documents
> **Output:** Source-grounded answer from Gemini with follow-up synthesis
...
| Step | Resource/Skill |
|------|----------------|
| Auth check | Authenticate.ts |
| Library check | ManageNotebook.ts |
| Query | AskQuestion.ts |
| Follow-up | AskQuestion.ts (repeat as needed) |
