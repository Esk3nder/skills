...
> **Trigger:** "add notebook" OR "list notebooks" OR "manage library"
> **Input:** Notebook URL, search query, or management command
> **Output:** Library state updated with confirmation
...
| Smart Add discovery | AskQuestion.ts |
| Library operations | ManageNotebook.ts |
